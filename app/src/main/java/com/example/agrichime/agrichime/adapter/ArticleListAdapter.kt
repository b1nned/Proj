...
class ArticleListAdapter(val context: Context, private val articleListData: List<DocumentSnapshot>, private val cellClickListener: CellClickListener): RecyclerView.Adapter<ArticleListAdapter.ArticleListViewholder>() {
    ...
    override fun onBindViewHolder(holder: ArticleListViewholder, position: Int) {
        ...
        holder.articleName.text = singleArticle.data!!["title"].toString()
        holder.articleCard.setOnClickListener {
            cellClickListener.onCellClickListener(singleArticle.data!!["title"].toString())
        }
        @Suppress("UNCHECKED_CAST") val list : List<String> = singleArticle.data!!["images"] as List<String>
