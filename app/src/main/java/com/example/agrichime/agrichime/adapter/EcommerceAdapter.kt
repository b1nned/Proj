...
class EcommerceAdapter(val context: Context, val ecommtListData : List<DocumentSnapshot>, private val cellClickListener: CellClickListener):
    RecyclerView.Adapter<EcommerceAdapter.EcommerceViewModel>() {

    lateinit var firebaseAuth: FirebaseAuth
    lateinit var firebaseFirestore: FirebaseFirestore
    class EcommerceViewModel(itemView: View): RecyclerView.ViewHolder(itemView) {
    ...
    override fun onBindViewHolder(holder: EcommerceAdapter.EcommerceViewModel, position: Int) {
